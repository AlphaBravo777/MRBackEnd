"""
Django settings for meatriteApi project.
...
# ALLOWED_HOSTS = ['192.168.45.2', 'localhost', '127.0.0.1','192.168.1.2', '192.168.2.24']
ALLOWED_HOSTS = ["*"]
...
MIDDLEWARE = [
    ...
    # 'whitenoise.middleware.WhiteNoiseMiddleware',   THis was to try and help with static files, but seems it is not necessary
